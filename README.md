...
- [`PRD.md`](PRD.md) — что делает продукт, для кого он и какие сценарии должны работать.
- [`AGENTS.md`](AGENTS.md) — технические правила для агента: стек, запуск, проверки, env vars и Railway.
